...
export function SiteHeader() {
  return <header className="site-header"><div className="container nav">
    ...
    <nav aria-label="Navegação principal"><Link href="/#solucoes">Soluções</Link><Link href="/#produtos">Produtos</Link><Link href="/produtos/layvo-gestao">Layvo Gestão</Link><a className="nav-cta" href="mailto:contato@layvo.com.br">Entrar em contato</a></nav>
  </div></header>;
}
