...
export function SiteHeader() {
  return <header className="site-header"><div className="container nav">
    ...
    <nav aria-label="Navegação principal"><Link href="/#recursos">Recursos</Link><Link href="/politica-de-privacidade">Privacidade</Link><a className="nav-cta" href="mailto:contato@layvo.com.br">Entrar em contato</a></nav>
  </div></header>;
}
...
export function SiteFooter() {
  return <footer className="footer"><div className="container footer-grid">
    ...
    <div><strong>Legal</strong><Link href="/politica-de-privacidade">Política de Privacidade</Link><Link href="/termos-de-uso">Termos de Uso</Link><Link href="/exclusao-de-conta">Exclusão de conta</Link></div>
